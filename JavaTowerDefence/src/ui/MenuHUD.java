...
public class MenuHUD {
    ...
    public void draw(Graphics2D g2d) {
        ...
        drawButton(g2d, startButton, "Start Game", new Color(33, 142, 88));
        drawButton(g2d, exitButton, "Exit", new Color(183, 47, 47));
    }
    ...
    private void drawButton(Graphics2D g2d, Rectangle button, String text, Color fillColor) {
